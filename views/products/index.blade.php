            ...
            <div class="row">
                <div class="col-lg-12 margin-tb">
                    <div class="pull-right mb-2">
                        <a class="px-4 py-1.5 text-white text-l bg-red-500 rounded" href="{{ route('products.create') }}"> Create Products</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="w-full max-w-sm mx-auto overflow-hidden bg-white rounded-md shadow-md">
                ...
                <div class="px-5 py-3">
                    ...
                    <div class="flex items-center justify-between mb-5">
                      ...
                      </div>  <h3 class="text-gray-700 uppercase">รายละเอียดสินค้า :{{ $item->description }}</h3> <br>
                         <h3 class="text-gray-700 uppercase"> ยี่ห้อ : {{ $item->brand->brand_name}}</h3> <br> 
                         <h3 class="text-gray-700 uppercase">ประเภท : {{ $item->category->category_name }}</h3> <br>
                       <h3 class="text-gray-700 uppercase">จำนวนสินค้า : {{ $item->product_stock }} ชิ้น </h3> <br>
                    ...
                    <form action="{{ route('cart.store') }}" method="POST" enctype="multipart/form-data" class="flex justify-end">
                        ...
                        <button class="px-4 py-1.5 text-white text-sm bg-red-700 rounded">Add To Cart</button>
